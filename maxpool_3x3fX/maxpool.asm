...
<Pool_Loop_X>
    ...
    fpu 2  .float vreg1 - vreg0, set mask if >;
    ...
    fpu 2  .float vreg0= mask ? vreg1 : vreg0;	//	MAX 0y
    ...
    fpu 0  .float vreg2 - vreg0, set mask if >;
    fpu 1  .float vreg2 - vreg0, set mask if >;
    fpu 2  .float vreg2 - vreg0, set mask if >;
    fp0_lmask = fp0_lmask;
    fp1_lmask = fp1_lmask;
    fp2_lmask = fp2_lmask;
    fpu 0  .float vreg0= mask ? vreg2 : vreg0;	//	MAX 1y
    fpu 1  .float vreg0= mask ? vreg2 : vreg0;	//	MAX 1y
    fpu 2  .float vreg0= mask ? vreg2 : vreg0;	//	MAX 1y
    ...
    fpu 0  .float vreg6 - vreg0, set mask if >;
    fp0_lmask = fp0_lmask;
    fpu 0  .float vreg0= mask ? vreg6 : vreg0;	//	MAX x-even-1
    ...
    fpu 1  .float vreg6 - vreg0, set mask if >;
    fp1_lmask = fp1_lmask;
    fpu 1  .float vreg0= mask ? vreg6 : vreg0;	//	MAX x-odd-1
